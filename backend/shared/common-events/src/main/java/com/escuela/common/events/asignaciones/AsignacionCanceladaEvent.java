...
public class AsignacionCanceladaEvent extends BaseEvent {
    ...
    public AsignacionCanceladaEvent() {
        super();
    }

    public AsignacionCanceladaEvent(Long asignacionId, Long instructorId, Long estudianteId,
                                    Long vehiculoId, LocalDateTime fechaHora, String motivoCancelacion) {
        super();
