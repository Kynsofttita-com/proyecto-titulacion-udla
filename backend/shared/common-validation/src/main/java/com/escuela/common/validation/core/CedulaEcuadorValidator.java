...
/**
 * Validador del digito verificador de la cedula ecuatoriana (10 digitos).
 *
 * <p>Reglas (DECISIONES.md seccion 11):</p>
 * <ol>
 *   <li>Exactamente 10 digitos numericos.</li>
 *   <li>Codigo de provincia (primeros 2 digitos) entre 01 y 24.</li>
 *   <li>Tercer digito menor a 6 (persona natural).</li>
 *   <li>Algoritmo modulo 10: digitos en posiciones impares (1,3,5,7,9)
 *       se multiplican por 2; si el resultado pasa de 9 se resta 9.
 *       Digitos en posiciones pares (2,4,6,8) quedan tal cual.</li>
 ...
 * </ol>
 */
public final class CedulaEcuadorValidator {

    private CedulaEcuadorValidator() {
        // utility class
    }
