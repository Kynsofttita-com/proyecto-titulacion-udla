...
class EstadoCuentaServiceImplTest {
    ...
    void testObtenerEstadoCuenta_WithMultipleInvoices() {
        ...
        FacturaListResponse pendienteResponse = new FacturaListResponse(1L, "FAC-0001", 1L, BigDecimal.valueOf(1000), BigDecimal.ZERO, BigDecimal.valueOf(1000), "PENDIENTE", LocalDate.now(), LocalDateTime.now());
        FacturaListResponse parcialResponse = new FacturaListResponse(2L, "FAC-0002", 1L, BigDecimal.valueOf(500), BigDecimal.valueOf(200), BigDecimal.valueOf(300), "PARCIAL", LocalDate.now(), LocalDateTime.now());
        FacturaListResponse vencidaResponse = new FacturaListResponse(4L, "FAC-0004", 1L, BigDecimal.valueOf(1500), BigDecimal.ZERO, BigDecimal.valueOf(1500), "PENDIENTE", LocalDate.now(), LocalDateTime.now());
